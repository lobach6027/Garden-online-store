      ...
      {product === undefined ? (
        replace("/*")
          ...
          <>
            ...
            {windowWidth>1350?(<CardScroll sameCategoryProducts ={sameCategoryProducts}/>):(<div className={s.addendum_products}>{sameCategoryProducts.map(item=><ProductCard key={item.id} {...item}/>)}</div>)}
          </>
          )}
    </div>
      );
